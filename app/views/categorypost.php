<div class="offcanvas-overlay"></div>
    ...
    <div class="breadcrumb-area">
        <?php
            $name='Danh Mục Chưa Có Bài Viết';
            foreach($categoryposthomebyid as $key =>$post_name){
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-9 order-lg-last col-md-12 order-md-first">
                    <?php
                        foreach($categoryposthomebyid as $key =>$post){
                    ?>
                    <div class="row mb-50px">
                        ...
                        <div class="col-lg-7 col-md-6 align-self-center align-items-center" data-aos="fade-up" data-aos-delay="400">
                            <div class="blog-post-content-inner mt-lm-20px">
                                ...
                                <h4 class="blog-title"><a href="<?php echo BASE_URL ?>/news/newsdetails/<?php echo $post['id_post']?>"><?php echo $post['title_post'] ?>.</a></h4>
                                <p>
