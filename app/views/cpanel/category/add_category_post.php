        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card">
              ...
              <div class="card-body">
                <form action="<?php echo BASE_URL ?>/category/insert_category_post" method="POST">
                    <div class="form-group">
                        <label for="email">Tên danh mục</label>
                        <input type="text" name="title_catedory_post" class="form-control" id="email">
                    </div>
                    <div class="form-group">
                        <label for="pwd">Mô tả danh mục</label>
                        <input type="text" name="desc_catedory_post" class="form-control" id="pwd">
                    </div>
