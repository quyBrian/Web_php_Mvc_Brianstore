            ...
            <div class="row">
                <div class="col-lg-9 order-lg-last col-md-12 order-md-first">
                    ...
                    <div class="shop-bottom-area">
                        ...
                        <div class="row">
                        <?php
                            foreach($listproducthome as $key =>$product){
                        ?> 
                                ...
                                <div class="product mb-25px">
                                    ...
                                    <div class="content">
                                        ...
                                        <span class="price">
                                            ...
                                            ?>
                                             <span class="new" style="color:#FF7704;"><?php echo number_format($product['price_product'],0,',','.').'đ'?></span>
                                             <span class="old" style="color:#BBBBBB;"><?php echo number_format($product['price_discount_product'],0,',','.').'đ'?></span>
                                            <?php
                                            }
                                            ?>
                                        </span>
                        ...
                        <?php
                                ...
                                if ($trang > 1 && $product_buttom > 1){
                                    echo '<a href="http://localhost:81/MvcPdo/Mvc1/productus/allproduct?trang='.($trang-1).'"> Trước </a> | ';
                                    //echo $trang;
                                }
                                $i=0;
                                for($i=1; $i<=$product_buttom; $i++){
                                    if ($i == $trang){
                                        ...
                                        echo '<a href="http://localhost:81/MvcPdo/Mvc1/productus/allproduct?trang='.$i.'">'.$i.'</a> | ';
                                    }
                                }

                                if ($trang < $product_buttom && $trang > 1){
                                    echo '<a href="http://localhost:81/MvcPdo/Mvc1/productus/allproduct?trang='.($trang+1).'">Tiếp</a> ';
                                }
                            ?> 
                        </div>
                        <!--  Pagination Area End -->
